...
public class Permissions {
	...
	public Permission perm8 = new Permission(SetTheSpawn.getInstance().getConfig().getString("cancel-teleport.move.permission"));
	...
	public Permission perm19 = new Permission("setthespawn.countdown.stopall");
	public Permission perm20 = new Permission(SetTheSpawn.getInstance().getConfig().getString("cancel-teleport.jump.permission"));
